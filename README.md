...
夜间经济：默认 `night_economy_enabled: true`。三座火箭、健康开拓者和两名健康工人齐备时，夜前安排开拓者共享两炮站位，一名工人操控第三炮，另一名工人保留独立回防位置。交接完成且往返路线满足敌人距离、攻击范围和回防余量时，释放该工人夜间采矿、批量出售；基地受击、墙体破口或没有安全收入路线时恢复三人防守。设为 `false` 可关闭该策略。正式判题器的夜间采集和实战收益仍需比赛验证。
