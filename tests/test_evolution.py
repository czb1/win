...
class EvolutionTests(unittest.TestCase):
    ...
    def test_accept_execute_submit_and_reuse_observed_solution(self):
        ...
        self.assertNotIn("python", mem.skills[0])
        self.assertNotIn('"北京"', json.dumps(mem.skills[0], ensure_ascii=False))
        self.assertEqual(mem.skills[0]['steps'][-1], 'compute_current_answer')
